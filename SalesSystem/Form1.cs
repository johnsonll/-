...
namespace SalesSystem
{
    ...
    {
        int count, a, j, orderrows, memberrows, icount,productrows;
        ...
        {
            if (rbtn來店消費.Checked && Convert.ToInt32(tb品項1數量.Text) >= Convert.ToInt32(lb庫存.Text))
            {
        ...
        private void btn加入常客_Click(object sender, EventArgs e)
        {
            ...
            string queryString = "insert into Customers values (" + lb會員號.Text + ",'" + tb銷售顧客稱謂.Text + "','"
            ...
            try
            {
                ...
                lb會員號.Text = (Convert.ToInt32(lb會員號.Text) + 1).ToString();
            }
            catch (Exception)
            {
        ...
        private void btn訂單搜尋_Click(object sender, EventArgs e)
        {
            ...
            if(rbtn已處理.Checked && ckbox來店.Checked && ckbox宅配.Checked)
                ...
                qs1 = "SELECT * FROM Orders where O_stat like '已%' and O_way != '來店';";
            using (SqlConnection cn = new SqlConnection(cs1))
            {
                //開啟資料庫
                cn.Open();
        ...
        private void btn清除搜尋結果_Click(object sender, EventArgs e)
        {
            ...
            rbtn已處理.Checked = false;
            rbtn未處理.Checked = true;
        }
        ...
        private void rbtn來店消費_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void rbtn來店預約宅配_CheckedChanged(object sender, EventArgs e)
        {
            cb品項1.SelectedIndex = -1;
            lb品項1單價.Text = "0";
            lb品項1小計.Text = "0";
        ...
        private void rbtn電話預訂門市取貨_CheckedChanged(object sender, EventArgs e)
        {
            cb品項1.SelectedIndex = -1;
            lb品項1單價.Text = "0";
            lb品項1小計.Text = "0";
        ...
        private void rbtn電話預訂宅配_CheckedChanged(object sender, EventArgs e)
        {
            cb品項1.SelectedIndex = -1;
            lb品項1單價.Text = "0";
            lb品項1小計.Text = "0";
        ...
        private void btn加入明細_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (int.TryParse(tb品項1數量.Text, out a))
                {
                    if (dg門市暫存明細.RowCount != 0)
                    {
        ...
        private void btn明細項刪除_Click(object sender, EventArgs e)
        {
            if (productrows > -1)
            {
                ...
                if (dg門市暫存明細.RowCount > 0)
                {
                    dg門市暫存明細.Rows.RemoveAt(productrows);
                }
            }
            else
            {
